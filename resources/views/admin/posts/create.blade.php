                            ...
                            <div class="card-body card-full">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="title"
                                        ...
                                        value="{{ old('title') }}" id="title" placeholder="Название">
                                </div>

                                <div class="form-froup">
                                    <label for="description">Цитата</label>
                                    <textarea name="description" class="form-control @error('description') is-invalid @enderror"
                                        value="{{ old('description') }}" id="description" rows="5" placeholder="Цитата ..."></textarea>
                                </div>

                                <div class="form-froup">
                                    <label for="content">Контент</label>
                                    <textarea name="content" class="form-control @error('content') is-invalid @enderror" value="{{ old('content') }}"
                                        id="content" rows="5" placeholder="Контент ..."></textarea>
                                </div>
