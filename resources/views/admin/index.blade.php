                        ...
                        <div class="card-header" id="card">
                            ...
                            <div class="card-tools">
                                <div class="input-group input-group-sm"
                                    style="width: 150px;float: left;margin-right: 0.5rem">
                                    <input type="text" name="table_search" class="form-control float-right"
                                        placeholder="Search" id="search-text" onkeyup="tableSearch()">
                                ...
                                <table class="table table-head-fixed table-bordered table-hover text-nowrap"
                                    ...
                                    <tbody>
                                        @foreach ($admins as $admin)
                                            <tr>
                                                <td style="width: 30px; text-align: center; padding-left: 0.75rem">
                                                    {{ $admin->id }}</td>
                                                <td>{{ $admin->name }}</td>
                                                <td>{{ $admin->email }}</td>
                    ...
                    <div class="card card-info">
                        ...
                        <div class="card-body">
                            ...
                            <canvas id="donutChart"
                                style="min-height: 250px; height: 250px; max-height: 250px; max-width: 100%; display: block; width: 797px;"
                                width="797" height="250" class="chartjs-render-monitor"></canvas>
                        </div>
                    </div>
