<ul class="list-inline share-icon-container">
    <li>
        <a href="https://vk.com/share.php?url={{ route('posts.single', ['post' => $post->slug]) }}"
    ...
    <li>
        <a href="https://www.facebook.com/sharer.php?u={{ route('posts.single', ['post' => $post->slug]) }}"
    ...
    <li>
        <a href="https://twitter.com/intent/tweet?text={{ route('posts.single', ['post' => $post->slug]) }}"
