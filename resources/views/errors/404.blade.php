...
<body>
    <div class="container">
        <svg class="milk-404" viewBox="0 0 500 500">
            ...
            <g id="milk-face">
                <path id="mouth" fill="none" stroke="#4f3e7c" stroke-linecap="round" stroke-miterlimit="10"
                    stroke-width="4" d="M338.4 239.8l32-3.9" />
                ...
                <path id="mouth-frown" fill="none" stroke="#4f3e7c" stroke-linecap="round" stroke-miterlimit="10"
                    stroke-width="4" d="M368.4 240.8s-15.4-10.5-27.3 3.5" />
                <g id="eyes">
                    <circle id="eye-right-open" cx="375.3" cy="215.6" r="5" fill="#4f3e7c" />
                    <circle id="eye-left-open" cx="330.9" cy="220" r="5" fill="#4f3e7c" />
                </g><!-- /#eyes -->
            </g><!-- /#milk-face -->
        </svg>
    </div>
